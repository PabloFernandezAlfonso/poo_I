...
public class Animal {
        ...
        public Animal(double precio,  String descripcion, int cantidad,  String especie){
         ...
         public void show(){
                System.out.printf("%d animales <%s> %s(%f) oferta = %b animal de ayuda = %b.%n", cantidad, especie, descripcion, precio, oferta, animalDeAyuda);
         }
        ...
        public static void main(String[] args) {
                ...
                Animal a3 = new Animal(1.65, 1, "primate");
